...
public class SearchResultBirthdayActivity extends AppCompatActivity implements IServiceListener, DialogClickListener, ReportBirthdayListAdapter.OnItemClickListener{
...
//        serviceArrayList = new ArrayList<>();
    ...
    private void getCategoryList(String event, String count) {
        ...
        String url = PreferenceStorage.getClientUrl(this) + GMSConstants.GET_REPORT_BIRTHDAY_SEARCH;
    ...
    public void onResponse(final JSONObject response) {
        ...
        if (validateResponse(response)) {
            ...
            ReportBirthdayListAdapter mAdapter = new ReportBirthdayListAdapter(birthdayArrayList, SearchResultBirthdayActivity.this);
