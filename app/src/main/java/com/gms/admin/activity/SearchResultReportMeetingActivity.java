...
public class SearchResultReportMeetingActivity extends AppCompatActivity implements IServiceListener, DialogClickListener, ReportMeetingListAdapter.OnItemClickListener{
...
//        serviceArrayList = new ArrayList<>();
    ...
    private void getCategoryList(String event, String count) {
        ...
        String url = PreferenceStorage.getClientUrl(this) + GMSConstants.GET_REPORT_MEETING_SEARCH;
    ...
    public void onResponse(final JSONObject response) {
        ...
        if (validateResponse(response)) {
            ...
            ReportMeetingListAdapter mAdapter = new ReportMeetingListAdapter(meetingArrayList, SearchResultReportMeetingActivity.this);
