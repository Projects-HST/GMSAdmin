...
import com.gms.admin.customview.MonthPickerView;
...
public class YearPickerDialog extends AlertDialog implements DialogInterface.OnClickListener, DatePicker.OnDateChangedListener {
    ...
    public static class Builder {
        ...
        private static final String TAG = YearPickerDialog.Builder.class.getName();
        ...
        private YearPickerDialog monthPickerDialog;
...
*                 {@link Calendar}Calender.MONTH or Calendar.JANUARY, Calendar.FEBRUARY etc)
        ...
        public Builder(Context context,
                       int datePickerTheme, OnDateSetListener callBack,
                       int year,
        ...
        public YearPickerDialog build() {
            ...
            monthPickerDialog = new YearPickerDialog(_context, _callBack, _activatedYear,
                    _activatedMonth);
            if (monthOnly) {
