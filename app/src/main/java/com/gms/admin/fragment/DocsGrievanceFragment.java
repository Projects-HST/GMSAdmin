...
public class DocsGrievanceFragment extends Fragment implements IServiceListener, DialogClickListener {

    private static final String TAG = DocsGrievanceFragment.class.getName();
    private View view;
    ...
    public static DocsGrievanceFragment newInstance(int position) {
        DocsGrievanceFragment frag = new DocsGrievanceFragment();
        Bundle b = new Bundle();
