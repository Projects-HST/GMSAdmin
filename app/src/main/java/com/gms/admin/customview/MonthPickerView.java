...
import com.gms.admin.adapter.MonthViewAdapter;
...
public class MonthPickerView extends FrameLayout {
    ...
    public static int _maxYear = Calendar.getInstance().get(Calendar.YEAR);
    ...
    YearPickerDialog.OnYearChangedListener _onYearChanged;
    YearPickerDialog.OnMonthChangedListener _onMonthChanged;
    ...
    */
    ...
    public void showYearOnly() {
        _monthList.setVisibility(View.GONE);
        _yearView.setVisibility(View.VISIBLE);
        _year.setVisibility(View.VISIBLE);
    ...
    public void setOnMonthChangedListener(YearPickerDialog.OnMonthChangedListener onMonthChangedListener) {
        if (onMonthChangedListener != null) {
            this._onMonthChanged = onMonthChangedListener;
        }
    }

    public void setOnYearChangedListener(YearPickerDialog.OnYearChangedListener onYearChangedListener) {
    ...
    YearPickerDialog.OnConfigChangeListener configChangeListener;

    public void setOnConfigurationChanged(YearPickerDialog.OnConfigChangeListener configChangeListener){
